            ...
            <Grid container spacing={4} style={{ flexWrap: 'wrap' }} >
                <Grid item xs={12} md={4}  className={style.topgrid}>
                    <Box className={style.singdiv}>
                        ...
                        <Box sx={{ width: '153px', color: "red" }} className={style.signuserbox}>
                            <LinearProgress variant="determinate" value={ 80 } height="8" className={style.signuser} id={style.linegrf} />
                        </Box>
                ...
                <Grid item xs={12} md={4} className={style.topgrid}>
                    ...
                    <Box className={style.singdiv2}>
                        ...
                        <Box sx={{ width: '153px', color: '#F9B8A5', }}>
                            <LinearProgress variant="determinate" value={ 50 } height="8" className={style.activeuser} id={style.linegrf} />
                        </Box>
                        {/* </Box> */}
                    </Box>
                ...
                <Grid item xs={12} md={4} className={style.topgrid}>
                    ...
                    <Box className={style.singdiv3}>
                        ...
                        <Box sx={{ width: '153px', color: '#FFC1D3', }}>
                            <LinearProgress variant="determinate" value={ 40 } height="8" className={style.inactiveuser} id={style.linegrf} />
                        </Box>
                    </Box>
