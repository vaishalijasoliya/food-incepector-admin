    ...
    <Grid container>
      ...
      <Grid container display={"flex"} className={styles.hadpeg}>
        ...
        <Grid className={styles.maxbox} item xs={12} md={9} sm={12}>
          ...
          >
            <DialogTitle className={styles.addadmintitle}>{listlegveg=="pl_PL"?"تحرير المسؤول":"Edit Admin"}</DialogTitle>
          ...
          >
            ...
            <Box className={styles.dialog_box} style={{ paddingTop: 0 }}>
              <Typography> {listlegveg=="pl_PL"?"هل أنت متأكد أنك تريد حذف المسؤول؟":"Are you sure you want to delete Admin?"}</Typography>
